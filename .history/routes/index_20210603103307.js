...
router.get('/about', function(req, res, next) {
  res.render('index', { title: 'About me', paratxt: 'I am a Software Engineering student at Centennnial College - Toronto - Canada I am 40 years old graduated before in Bus'});
});
