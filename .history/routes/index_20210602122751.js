...
router.get('/', function(req, res, next) {
  res.render('index', { title: 'Home', paratxt: 'Welcome to my webpage here you will find information about myself as graduation information, courses and history about my life. ' });
});
