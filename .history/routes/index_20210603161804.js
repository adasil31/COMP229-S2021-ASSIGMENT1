...
router.get('/home', function(req, res, next) {
  res.render('home', { title: 'Home', paratxt: 'Welcome to my webpage, here you will find information about myself .I am Software Eng Student at Centennial College - Toronto  - Canada ' });
});
